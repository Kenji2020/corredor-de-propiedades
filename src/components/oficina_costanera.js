            ...
            <div className="row ">
              <div className="col-xl-9 col-lg-8">
                  ...
                  <div className="item">
                    ...
                    >
                      <div class="carousel-item active">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/1.jpg"}
                          alt="First slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/2.jpg"}
                          alt="Second slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/3.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/4.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/5.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/6.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/7.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Oficina costanera center/8.jpg"}
                          alt="Third slide"
                        />
                      </div>
                ...
                <div className="property-details-slider-info">
                  <h3>
                    <span>$600.000 mensual</span> Oficina frente Costanera Center
                  </h3>
                </div>
              </div>
                    ...
                    <div className="single-property-info">
                      ...
                      <p>
                        <img
                          ...
                          alt={imagealt}
                        />
                        Arriendo oficina amoblada frente al costanera center. Acondicionada para consulta médica; a pasos de estación metro Los Leones. 2 privados, 2 baños, recepción. Lindas vistas. Excelente ubicación.                         </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"></div>
                </div>
