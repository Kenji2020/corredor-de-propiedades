            ...
            <div className="row justify-content-center">
              <div className="col-xl-9 col-lg-10">
                ...
                <div className="row pd-top-100">
                  <div className="col-md-4">
                    <div className="section-title">
                      <h4><img src={publicUrl+"assets/img/icons/28.png" }alt="img" />Nombre de la casa</h4>
                    </div>
                  </div>
                  <div className="col-md-8">
                    <div className="section-title">
                      <input type="text" className="form-control" placeholder="Ingrese el nombre de la casa"/>
                    </div>
                    <div className="row">
                      <div className="col-lg-6 mb-3">
                        <div className="rld-single-select">
                          <input type="text" className="form-control" placeholder="Ingrese la cantidad de habitaciones"/>
                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="rld-single-select">
                        <input type="text" className="form-control" placeholder="Ingrese la cantidad de baños"
                        />
                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="rld-single-select">
                        <input type="text" className="form-control" placeholder="Ingrese el tamaño del hogar"/>

                        </div>
                      </div>
                      <div className="col-lg-6 mb-3">
                        <div className="rld-single-select">
                        <input type="text" className="form-control" placeholder="Ingrese la cantidad de estacionamientos"/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row pd-top-80">
                  <div className="col-md-4">
                    <div className="section-title">
                      <h4><img src={publicUrl+"assets/img/icons/29.png"} alt="img" />Dirección</h4>
                    </div>
                  </div>
                  <div className="col-md-8">
                    <div className="section-title">
                      <h4>Ingrese la dirección aquí</h4>
                    </div>
                    <div className="row">
                      <div className="col-lg-6 mb-3">
                        <div className="rld-single-select">
                  ...
                  <div className="col-md-8">
                    <div className="row">
                      ...
                      <div className="col-12 mt-5">
                        <a className="btn btn-success" href="#">Publish property</a>
                      </div>
                    </div>
                  </div>
                </div>
