                  ...
                  <div className="col-lg-12">
                    <div className="property-filter-menu-wrap">
                      <div className="property-filter-menu portfolio-filter text-center">
                        <button data-filter="*" className="active">Todas las propiedades</button>
                        <button data-filter=".cat1">Mejores propiedades</button>
                        <button data-filter=".cat2">Casas más grandes</button>
                        <button data-filter=".cat3">Mayor demanda</button>
                      </div>
                    </div>
                  </div>
                </div>
