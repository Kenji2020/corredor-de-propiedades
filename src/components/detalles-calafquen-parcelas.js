            ...
            <div className="row ">
              <div className="col-xl-9 col-lg-8">
                  ...
                  <div className="item">
                    ...
                    >
                      <div class="carousel-item active">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcelas lago calafquen/1.jpg"}
                          alt="First slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcelas lago calafquen/2.jpg"}
                          alt="Second slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcelas lago calafquen/3.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcelas lago calafquen/4.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcelas lago calafquen/5.jpg"}
                          alt="Third slide"
                        />
                      </div>
                ...
                <div className="property-details-slider-info">
                  <h3>
                    <span>$800.000.000</span> Parcelas en Calafquén
                  </h3>
                </div>
              </div>
                    ...
                    <div className="single-property-info">
                      ...
                      <p>
                        <img
                          ...
                          alt={imagealt}
                        />
                        Lago Calafquén; Parcelas 4 hectáreas con 300 mts de playa; vista a 5 volcanes
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"></div>
