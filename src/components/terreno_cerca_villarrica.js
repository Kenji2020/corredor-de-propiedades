          ...
          <div className="row ">
            <div className="col-xl-9 col-lg-8">
                  ...
                  >
                    <div class="carousel-item active">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/1.jpg"
                        }
                        alt="First slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/2.jpg"
                        }
                        alt="Second slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/3.jpg"
                        }
                        alt="Second slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/4.jpg"
                        }
                        alt="Second slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/5.jpg"
                        }
                        alt="Second slide"
                      />
                    </div>
                    <div class="carousel-item">
                      <img
                        ...
                        src={
                          publicUrl +
                          "assets/img/Terreno cerca villarrica/6.jpg"
                        }
                        alt="Second slide"
                      />
                    </div>
              ...
              <div className="property-details-slider-info">
                <h3>
                  <span>$375.000.000</span> Terreno cerca de Villarrica
                </h3>
              </div>
            </div>
                  ...
                  <div className="single-property-info">
                    ...
                    <p>
                      <img
                        ...
                        alt={imagealt}
                      />
                      25 hectáreas; a 20 km de villarrica, luz y agua a
                      conectar, con orilla de rio. Vistas, entorno nativo,
                      disponibilidad de mostrar en avión{" "}
                    </p>
                  </div>
                </div>
                <div className="col-md-3 col-sm-6"></div>
