            ...
            <div className="row ">
              <div className="col-xl-9 col-lg-8">
                  ...
                  <div className="item">
                    ...
                    >
                      <div class="carousel-item active">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/1.jpg"}
                          alt="First slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/2.jpg"}
                          alt="Second slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/3.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/4.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/5.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/6.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/7.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/8.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/9.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/10.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/11.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/12.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Terreno en galletue/13.jpg"}
                          alt="Third slide"
                        />
                      </div>
                    </div>
                ...
                <div className="property-details-slider-info">
                  <h3>
                    <span>$120.000.000</span> Terreno en Galletue
                  </h3>
                </div>
              </div>
