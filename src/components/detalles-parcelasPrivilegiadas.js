            ...
            <div className="row ">
              <div className="col-xl-9 col-lg-8">
                  ...
                  <div className="item">
                    ...
                    >
                      <div class="carousel-item active">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/1.jpg"}
                          alt="First slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/2.jpg"}
                          alt="Second slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/3.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/4.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/5.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/6.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/7.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/8.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/9.jpg"}
                          alt="Third slide"
                        />
                      </div>
                      <div class="carousel-item">
                        <img
                          class="d-block w-100"
                          src={publicUrl + "assets/img/Parcela lago maihue 2/10.jpg"}
                          alt="Third slide"
                        />
                      </div>
                    </div>
                ...
                <div className="property-details-slider-info">
                  <h3>
                    <span>$160.000.000</span> Parcelas privilegiadas en Maihue
                  </h3>
                </div>
              </div>
                    ...
                    <div className="single-property-info">
                      ...
                      <p>
                        <img
                          ...
                          alt={imagealt}
                        />
                        Lago Mahihue; 4.5 hectáreas con derecho a playa; Parcela ubicada en un entorno privilegiado con vistas únicas del lago.
                      </p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6"></div>
